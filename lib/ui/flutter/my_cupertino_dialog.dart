...
/// [MyCupertinoAlertDialog], which implement a specific kind of dialog.
///
...
/// See also:
///
///  * [MyCupertinoAlertDialog], which is a dialog with title, contents, and
///    actions.
///  * <https://developer.apple.com/ios/human-interface-guidelines/views/alerts/>
@Deprecated(
    'Use MyCupertinoAlertDialog for alert dialogs. Use CupertinoPopupSurface for custom popups. '
...
/// rendering divider gaps for a more complicated layout, e.g., [MyCupertinoAlertDialog].
...
/// See also:
///
///  * [MyCupertinoAlertDialog], which is a dialog with a title, content, and
///    actions.
///  * <https://developer.apple.com/ios/human-interface-guidelines/views/alerts/>
...
class _CupertinoDialogRenderWidget extends RenderObjectWidget {
  const _CupertinoDialogRenderWidget({
    Key? key, required this.contentSection,
...
class _RenderCupertinoDialog extends RenderBox {
  _RenderCupertinoDialog({
    ...
    Color dividerColor = CupertinoColors.activeGreen,
...
// The "content section" of a MyCupertinoAlertDialog.
//
...
// The "actions section" of a [MyCupertinoAlertDialog].
//
...
/// See also:
///
///  * [MyCupertinoAlertDialog], a dialog that informs the user about situations
...
class _CupertinoDialogActionsRenderWidget extends MultiChildRenderObjectWidget {
  _CupertinoDialogActionsRenderWidget({
    Key? key, required List<Widget> actionButtons,
    double dividerThickness = 0.0,
  })  : _dividerThickness = dividerThickness,
